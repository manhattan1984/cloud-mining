...
import sty from "./PlasmicButton.module.css"; // plasmic-import: L7yFkYpvXpI/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___9E4A)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon9Icon
                className={classNames(projectcss.all, sty.svg__fEksg)}
                role={"img"}
              />
            ),
